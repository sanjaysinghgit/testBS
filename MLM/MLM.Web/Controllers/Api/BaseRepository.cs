...
namespace MLM
{
    public class BaseRepository<T> where T : MLMBaseEntity
    {
        public RepositoryBase<T> EntityRepository  { get; set; }
        public MLMSqlRepository<T> SQLRepository { get; set; }
        public ILog Logger { get; set; }
        public IExceptionHandler ExceptionHandler { get; set; }

        public BaseRepository()
        {
            EntityRepository = new RepositoryBase<T>();
            SQLRepository = new MLMSqlRepository<T>();
