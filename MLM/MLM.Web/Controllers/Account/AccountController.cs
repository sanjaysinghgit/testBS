...
namespace MLM.Controllers
{
    ...
    public class AccountController : Controller
    {
        public AccountController()
            : this(new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(new MLMDbContext("MLMCon"))), new AgentRepository<Agent>(), new SPRepository<Agent>())
        {
        }

        public AccountController(UserManager<ApplicationUser> userManager, AgentRepository<Agent> AgentHandler, SPRepository<Agent> SPRepository)
        {
            UserManager = userManager;
            _AgentRepository = AgentHandler;
            _SPRepository = SPRepository;
        }

        private readonly AgentRepository<Agent> _AgentRepository;
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    String agentApplicableSponsorCode = _SPRepository.GetAgentApplicableSponsorCode(model.SponsorCode, model.Position);

                    if (model.SponsorCode == string.Empty || agentApplicableSponsorCode == string.Empty || agentApplicableSponsorCode.Equals("0"))
                    {
